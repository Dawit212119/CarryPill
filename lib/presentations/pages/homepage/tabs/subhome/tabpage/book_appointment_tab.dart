                ...
                children: [
                  ...
                  Builder(
                    builder: (context) {
                      ...
                      return QueueTokenSection(
                        patientUid: uid,
                        initialTokenNum: _tokenNum,
                        initialImageUrl: _tokenImageUrl,
                        onTokenNumChanged: (n) => setState(() => _tokenNum = n),
                        onImageUrlChanged: (url) =>
                            setState(() => _tokenImageUrl = url),
                      );
                    },
                  ),
                  gaphr(h: 12.5),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          gaphr(h: 16),
                          ClinicMedicationChecklist(clinics: clinicList),
                          ListView.builder(
